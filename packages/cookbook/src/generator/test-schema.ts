...
export async function testSchema(options: CookbookOptions, paths: { cwd: string, milkio: string, generated: string }, project: CookbookOptions['projects']['key']) {
  ...
  const typescriptImports = `/* eslint-disable */\n// test-schema`
