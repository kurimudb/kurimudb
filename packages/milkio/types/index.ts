...
export interface MilkioResponseReject<Code extends keyof $rejectCode = keyof $rejectCode> { success: false, code: Code, reject: $rejectCode[Code], executeId: string }

export interface MilkioResponseSuccess<Path extends keyof Generated['routeSchema'], Generated extends $types['generated'] = $types['generated']> { success: true, data: Generated['routeSchema'][Path]['result'], executeId: string }
