...
* It can be edited in the /packages/cookbook-dto/src/index.ts file, and each time you run bun run dev, the generated file will be synced to another location based on the content of the /develop.ts.
*/\n\n`;
